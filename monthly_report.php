                                ...
                                <div class="card-body">
                                    ...
                                    <p id="header_chart" class=" align-middle text-center font-weight-bold " style="font-size:30px" >Monthly Report Matrix Eye Check <br> <?php
                                                 ...
                                                 if(isset($_SESSION["star"]) and isset ($_SESSION["end"])){
                                                    ...
                                                    $_SESSION["end"] = date("F-Y",strtotime ($_SESSION["end"]));
                                                    echo $_SESSION["star"];
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-sm-12 col-sm-12">
                                            <table class="table table-bordered table-lg "  style="font-size:12px" width="100" height="100" cellspacing="0">
                                                ...
                                                <tr>
                                                <td rowspan="2" class="align-middle text-center"><img src="img/na.png" height="35px"></td></td>
                                                ...
                                                <tr>
                                                <td rowspan="2"class="align-middle text-center"><img src="img/open.png" height="35px"></td></td>
                                                <td>HASIL SPOT NG ( TIDAK DITEMUKAN HASIL SPOT)</td>
                                                </tr>
                                                <tr>
                                                <td class="">TELAH TERKONFIRMASI OK</td>
                                                </tr>
                                                <td rowspan="2" class="align-middle text-center"><img src="img/small.png" height="35px"></td></td>
                                                ...
                                                <tr>
                                                <td rowspan="2" class="align-middle text-center"><img src="img/stick.png" height="35px"></td></td>
                                                <td>HASIL SPOT NG (KETEBALAN NUGGET KECIL /TIDAK DITEMUKAN)</td>
                                                </tr>
                                                <tr>
                                                <td class="">TELAH TERKONFIRMASI OK</td>
                                                </tr>
                                                <td rowspan="2" class="align-middle text-center "><img src="img/thin.png" height="35px"></td></td>
