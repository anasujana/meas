...
$row = 0; 
    ...
    $tagane = $data['tagane'];
        ...
        $a[$row][8]= $Weld_type;
        $a[$row][9]= $Result;
        // $a[$row][10]= "<img src='img/img_me/$No.jpg' alt='' class='data' width=30px data-toggle='modal' data-image='$No' data-target='#exampleModal'>";                             
    $row++;
